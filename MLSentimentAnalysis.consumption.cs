...
namespace SampleMLBot
{
    public partial class MLSentimentAnalysis
    {
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("Analysis");
            if (labelColumn == null)
            {
                throw new Exception("Analysis column not found. Make sure the name searched for matches the name in the schema.");
            }
