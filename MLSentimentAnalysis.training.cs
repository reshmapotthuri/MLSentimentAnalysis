...
namespace SampleMLBot
{
    ...
    {
        public const string RetrainFilePath =  @"D:\Reshma-Projects\SampleMLBot\TrainingData.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"Message",outputColumnName:@"Message")      
                                    ...
                                    .Append(mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"Analysis",inputColumnName:@"Analysis",addKeyValueAnnotationsAsText:false))      
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastForest(new FastForestBinaryTrainer.Options(){NumberOfTrees=9,NumberOfLeaves=4,FeatureFraction=0.986735F,LabelColumnName=@"Analysis",FeatureColumnName=@"Features"}),labelColumnName:@"Analysis"))      
